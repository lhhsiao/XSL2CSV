...
public class STARECCalanderReader {
...
//			Cell cell1 = sheet.getCell(0, i);
			...
			if (sheet[i][1].toUpperCase().indexOf(HEADER_KEY)>-1) {
				startIndexOfPageList.add(new Integer(i));
				return i;
			}
...
//			System.out.println("str_weekday_day: "+str+" "+str_weekday_day.length);
...
//					temp.setEngName(names[1]);
				...
				if(name.indexOf("~#")>0)
					...
					temp.setName(name);
				String time_str=sheet[y][1].trim();
